...
<head>
  ...
  <title>Editar Instalador | Painel Administrativo Web ID</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <?php
                  ...
                  $_SESSION['id'] = $id;
                  $querySelect = $conexao->query("select * from instaladores where id='$id'");
                  ...
                  while($registros = $querySelect->fetch_assoc()):
                      ...
                      $fantasia = $registros['fantasia'];
                      $pagamento = $registros['pagamento'];
          ...
          <div class="col-sm-12">
                <div class="card">
                  <div class="card-header display-4">
                    <i class="fa fa-align-justify"></i> Editar Instalador <span class="h1 btn btn-dark" style="float:right;">#<?php echo $id ?></span></div>
                  <div class="card-body">
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">

                    <form method="post" action="config/update-instalador.php">
                    <div class="row">
                      <!-- LINHA 1 -->
                      ...
                      <div class="form-group col-sm-4">
                        ...
                        <input class="form-control" id="contato" type="text" name="contato" value="<?php echo $contato ?>">
                      </div>

                      <div class="form-group col-sm-4">
                        <label for="fantasia">Nome Fantasia</label>
                        <input class="form-control" id="fantasia" type="text" name="fantasia" value="<?php echo $fantasia ?>">
                      </div>
               ...
               onblur="pesquisacep(this.value);" placeholder="Digite o CEP" >
                      ...
                      <div class="form-group col-sm-4">
                        ...
                        <input class="form-control" id="pagamento" type="text" name="pagamento" value="<?php echo $pagamento ?>">
                      </div>
                      ...
                      <div class="form-group col-sm-4">
                       ...
                       <div class="form-group col-sm-4">
                        ...
                        <select class="form-control" id="instalador" type="text" name="instalador">
                          <option><?php echo $instalador ?></option>
                          <option>Sim</option>
                          <option>Não</option>
                        </select>
                      </div>
