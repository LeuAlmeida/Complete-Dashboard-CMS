...
$querySelect = $conexao->query("SELECT * FROM clientes WHERE nome LIKE '%$filtro%' LIMIT $offset, $no_of_records_per_page");
                  ...
                  <div class="card-header display-4">
                    ...
                    <div class="row">
                       ...
                       <div class="form-group col-sm-3">
                        ...
                        <input class="form-control" id="filtro" type="text" name="filtro" placeholder="Nome do Cliente">
                      ...
                      <div class="form-group col-sm-3">
                        ...
                        <input class="form-control" id="fequipamento" type="text" name="fequipamento" placeholder="Número do ID" disabled>
                      ...
                      <div class="form-group col-sm-3">
                        ...
                        <select class="form-control" id="filtro_situacao" type="text" name="filtro_situacao" disabled>
                      ...
                      <div class="form-group col-sm-3">
                        ...
                        <input class="form-control" id="fplaca" type="text" name="fplaca" maxlength="8" placeholder="AAA-0000" disabled>
