...
$querySelect = $conexao->query("select * from instaladores where nome like '%$filtro%' ");
          ...
          <div class="col-sm-12">
                <div class="card">
                  <div class="card-header display-4">
                    <i class="fa fa-align-justify"></i> Listagem de Instaladores</div>
                  <div class="card-body">
                    <a class="btn btn-rounded navbar default-layout text-white d-block text-uppercase" data-toggle="collapse" href="#filtroCollapse" role="button" aria-expanded="false" aria-controls="filtroCollapse">
                      Filtro de Instaladores <i class="fas fa-search"></i>
                    </a>
                    ...
                    <div class="row">
                       <div class="form-group col-sm-12">
                        ...
                        <input class="form-control" id="filtro" type="text" name="filtro" placeholder="Nome do Instalador">
                      </div>
                      <!--
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        while($registros = $querySelect->fetch_assoc()):
                          ...
                          $instalador = $registros['instalador'];
                          $celular = $registros['celular'];

                          echo "<tbody><tr><th scope='row'>" . $id . "</th>";
                          echo "<td>" . $nome . "</td>";
                          echo "<td>" . $cidade . "</td>";
                          echo "<td>" . $instalador . "</td>";
                          echo "<td>" . $celular . "</td>";
                          echo "<td>" . "<center>" . "<a href='editar-instalador.php?id=$id' data-toggle='tooltip' data-placement='left' title='Editar' class='btn btn-icons btn-rounded btn-primary'><i class='fas fa-edit' style='margin-top:2px;'></i></a> 
                            <a href='config/deletar-instalador.php?id=$id' onclick='return checkDelete()' class='btn btn-icons btn-rounded btn-danger' data-toggle='tooltip' data-placement='top' title='Excluir'><i class='fas fa-trash-alt' style='margin-top:2px;'></i></a>" . "</center>" . "</td>" . "</tr>";
