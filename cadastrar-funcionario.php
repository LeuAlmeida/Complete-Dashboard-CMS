...
<head>
  ...
  <title>Cadastrar Funcionário | Painel Administrativo Web ID</title>
  <!-- plugins:css -->
          ...
          <div class="col-sm-12">
                <div class="card">
                  <div class="card-header display-4">
                    <i class="fa fa-align-justify"></i> Cadastro de Funcionário</div>
                  <div class="card-body">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="post" action="config/processa-funcionario.php">
                    <div class="row">
                      <!-- LINHA 1 -->
                      ...
                      <div class="form-group col-sm-6">
                        ...
                        <input class="form-control" id="nome" name="nome" type="text" placeholder="Nome completo do Funcionário">
                      </div>
               ...
               onblur="pesquisacep(this.value);" placeholder="Digite o CEP" >
                      ...
                      <div class="form-group col-sm-4">
                        ...
                        <input class="form-control" id="clt" type="text" name="clt" placeholder="Digite o Número">
                      </div>

                      <div class="form-group col-sm-4">
                        <label for="serie">Série</label>
                        <input class="form-control" id="serie" type="text" name="serie" placeholder="Digite a Série">
                      </div>

                      <div class="form-group col-sm-4">
                        <label for="funcao">Função</label>
                        <input class="form-control" id="funcao" type="text" name="funcao" placeholder="Digite a Função">
                      </div>
